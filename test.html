<h1 id="welcome" class="wmd-title">Welcome to StackEdit!  </h1>
...
<p><strong>StackEdit</strong> stores your documents in your browser local storage, which means all your documents are automatically saved locally and are accessible offline.</p>

<blockquote>
  <p><strong>NOTE:</strong> This also means that your documents are not shared between different browsers or computers and that clearing your browser’s data may <strong>delete all of them!</strong></p>
</blockquote>
...
<h4 class="wmd-title" id="save-a-document"><i class="icon-hdd"></i> Save a document</h4>

<p>You can save the current document to a file using the <i class="icon-hdd"></i> <code>Save as...</code> sub-menu.</p>

<blockquote>
  <p><strong>NOTE:</strong> See <a href="#publish-a-document"><i class="icon-share"></i> Publish a document</a> section for a description of the different outputs.</p>
</blockquote>
...
<blockquote>
  <p><strong>NOTE:</strong> Full access to <strong>Google Drive</strong> or <strong>Dropbox</strong> is required to be able to import any document in StackEdit. Imported documents are downloaded in your browser and are not transmitted to a server.</p>
</blockquote>
...
<blockquote>
  <p><strong>NOTE:</strong> You can disable any <strong>Markdown Extra</strong> feature in the <code>Extensions</code> tab of the <i class="icon-cog"></i> <code>Settings</code> dialog.</p>
</blockquote>
...
<p>GitHub’s fenced code blocks are also supported with <strong>Prettify</strong> syntax highlighting:</p>
...
<h3 class="wmd-title" id="smartypants">SmartyPants</h3>
...
<div class="footnotes"><hr><ol><li id="fn:stackedit">StackEdit is a free, open-source Markdown editor based on PageDown, the Markdown library used by Stack Overflow and the other Stack Exchange sites. <a href="#fnref:stackedit" title="Return to article" class="reversefootnote">↩</a></li><li id="fn:footnote">Here is the <em>text</em> of the <strong>footnote</strong>. <a href="#fnref:footnote" title="Return to article" class="reversefootnote">↩</a></li></ol></div>